...
export const metadata: Metadata = {
  title: "Comprar Curso Avançado - Studio Bia Araújo",
  description: "Adquira o Curso Avançado e especialize-se em alisamento sem formol. Apenas R$ 1100!",
};

export default function ComprarAvancadoPage() {
  const whatsappLink = "https://wa.me/556191230004?text=Olá!%20Tenho%20interesse%20no%20Curso%20Avançado%20e%20gostaria%20de%20mais%20informações.";
  const coursePrice = "R$ 1.100,00";
  const installmentPrice = "12x de R$ 91,67";

  const benefits = [
    "Especialização em alisamento 100% sem formol.",
    "Técnicas modernas e seguras.",
    "Kit de especialista com produtos premium.",
    "Aprenda a precificar e vender seu novo serviço."
  ];
      ...
      <div className="container max-w-5xl mx-auto">
        <div className="grid lg:grid-cols-2 items-stretch bg-black/50 border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="relative w-full h-80 lg:h-auto">
            <Image
              src="/2.jpeg" // <-- MANTENHA O NOME DA SUA IMAGEM
            ...
            <div className="mt-10">
                ...
                <div className="space-y-4">
                    <p className="text-gray-300 text-sm">
                        Clique abaixo para garantir sua vaga na especialização ou tirar dúvidas diretamente com a Bia.
                    </p>
                    <Button asChild size="lg" className="w-full bg-brand-gold text-primary-foreground hover:bg-brand-yellow font-bold text-lg px-8 py-7 shadow-xl group">
                        ...
                        Quero me Especializar <BsWhatsapp size={22} className="ml-3 group-hover:scale-110 transition-transform" />
                        </a>
                    </Button>
                </div>
            </div>
